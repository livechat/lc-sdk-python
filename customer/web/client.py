...
# Chats
    ...
    def list_chats(self,
                   ...
                   limit: int = None,
                   sort_order: str = None,
                   page_id: str = None) -> requests.Response:
    ...
    def get_chat(self,
                 payload: dict = None,
                 chat_id: str = None,
                 thread_id: str = None) -> requests.Response:
    ...
    def start_chat(self,
                   ...
                   chat: dict = None,
                   active: bool = None,
                   continuous: bool = None) -> requests.Response:
        ''' Starts a chat.
...
# Configuration
    ...
    def get_dynamic_configuration(self,
                                  ...
                                  test: bool = None) -> requests.Response:
    ...
    def get_configuration(self,
                          payload: dict = None,
                          group_id: int = None,
                          version: str = None) -> requests.Response:
...
# Events
    ...
    def send_event(self,
                   ...
                   chat_id: str = None,
                   event: dict = None,
                   attach_to_last_thread: bool = None) -> requests.Response:
    ...
    def upload_file(self,
                    payload: dict = None,
                    file: typing.BinaryIO = None) -> requests.Response:
    ...
    def send_sneak_peek(self,
                        payload: dict = None,
                        chat_id: str = None,
                        sneak_peek_text: str = None) -> requests.Response:
...
# Properties
    ...
    def update_chat_properties(self,
                               payload: dict = None,
                               id: str = None,
                               properties: dict = None) -> requests.Response:
...
# Customers
    ...
    def update_customer(self,
                        ...
                        email: str = None,
                        avatar: str = None,
                        session_fields: list = None) -> requests.Response:
    ...
    def set_customer_session_fields(
            self,
            payload: dict = None,
            session_fields: list = None) -> requests.Response:
...
# Status
    ...
    def list_group_statuses(self,
                            payload: dict = None,
                            all: bool = None,
                            group_ids: list = None) -> requests.Response:
...
# Other
    ...
    def check_goals(self,
                    ...
                    group_id: int = None,
                    page_url: str = None) -> requests.Response:
    ...
    def get_form(self,
                 payload: dict = None,
                 group_id: int = None,
                 type: str = None) -> requests.Response:
    ...
    def mark_events_as_seen(self,
                            payload: dict = None,
                            chat_id: str = None,
                            seen_up_to: str = None) -> requests.Response:
    ...
    def accept_greeting(self,
                        ...
                        unique_id: str = None) -> requests.Response:
