...
class CustomerRTMInterface(metaclass=ABCMeta):
    ...
    def open_connection(self) -> None:
        ''' Method opens WebSocket connection. '''
        self.ws.open()

    def close_connection(self) -> None:
        ''' Method closes WebSocket connection. '''
        self.ws.close()
    ...
    def login(self, token: str = None, payload: dict = None) -> dict:
        ''' Logs in customer.
                  Args:
                       ...
                       payload (dict):  Payload contains custom `login` object.
                  Returns:
    ...
    def list_group_statuses(self,
        ...
        ''' Lists statuses of groups.
                  Args:
                      ...
                      payload (dict): Payload contains custom `list_group_statuses` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def start_chat(self,
        ...
        ''' Starts a chat.
                  Args:
                       ...
                       payload (dict): Payload contains custom `start_chat` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def resume_chat(self,
        ...
        '''Restarts an archived chat.
                  Args:
                       ...
                       payload (dict): Payload contains custom `resume_chat` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def get_chat(self,
        ...
        ''' It returns a thread that the current Customer has access to in a given chat.
                  Args:
                      ...
                      payload (dict): Payload contains custom `get_chat` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def list_chats(self,
        ...
        ''' It returns summaries of the chats a Customer participated in.
                  Args:
                      ...
                      sort_order (str): Possible values: asc, desc (default). Chat summaries are sorted by the creation date of its last thread.
                      page_id (str): Page id.
                      payload (dict): Payload contains custom `list_chats` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def list_threads(self,
        ...
        ''' It returns threads that the current Customer has access to in a given chat.
                  Args:
                      ...
                      sort_order (str): Possible values: asc - oldest threads first and desc - newest threads first (default).
                      limit (int): Default: 3, maximum: 100.
                      page_id (str): Page id.
                      min_events_count (int):Range: 1-100; Specifies the minimum number of events to be returned in the response.
                      payload (dict): Payload contains custom `list_threads` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def deactivate_chat(self, id: str = None, payload: dict = None) -> dict:
        ''' Deactivates a chat by closing the currently open thread.
                  Args:
                      ...
                      payload (dict): Payload contains custom `deactivate_chat` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def send_event(self,
        ...
        ''' Sends an Event object.
                   Args:
                       ...
                       payload (dict): Payload contains custom `send_event` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def send_sneak_peek(self,
        ...
        ''' Sends a sneak peek to a chat.
                 Args:
                       ...
                       payload (dict): Payload contains custom `send_sneak_peek` object.
                  Returns:
                    dict: Dictionary with response.
           '''
        if payload is None:
    ...
    def send_rich_message_postback(self,
        ...
        ''' Sends rich message postback.
                 Args:
                       ...
                       payload (dict): Payload contains custom `send_rich_message_postback` object.
                  Returns:
                    dict: Dictionary with response.
           '''
        if payload is None:
    ...
    def accept_greeting(self,
        ...
        ''' Marks an incoming greeting as seen.
                  Args:
                      ...
                      payload (dict): Payload contains custom `accept_greeting` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def cancel_greeting(self,
        ...
        ''' Cancels a greeting.
                  Args:
                      unique_id (str): Specific greeting event ID.
                      payload (dict): Payload contains custom `cancel_greeting` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def get_url_info(self, url: str = None, payload: dict = None) -> dict:
        ''' It returns the info on a given URL.
                  Args:
                      ...
                      payload (dict): Payload contains custom `get_url_info` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def get_form(self,
        ...
        ''' Returns an empty ticket form of a prechat or postchat survey.
                  Args:
                      ...
                      payload (dict): Payload contains custom `get_form` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def get_predicted_agent(self, payload: dict = None) -> dict:
        ''' Gets the predicted Agent - the one the Customer will chat with when the chat starts.
                  Args:
                       payload (dict): Payload contains custom data.
                  Returns:
                    dict: Dictionary with response.
          '''
        return self.ws.send({
    ...
    def mark_events_as_seen(self,
        ...
        ''' Marks events as seen by agent.
                  Args:
                       ...
                       payload (dict): Payload contains custom `mark_events_as_seen` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def update_customer(self,
        ...
        ''' Updates customer's properties.
                  Args:
                       ...
                       session_fields (list): An array of custom object-enclosed key:value pairs. Respects the order of items.
                       payload (dict): Payload contains custom `update_customer` object..
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def update_customer_page(self,
        ...
        ''' Updates customer's page.
                  Args:
                       ...
                       payload (dict): Payload contains custom `update_customer_page` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def set_customer_session_fields(self,
        ...
        ''' Sets customer's session fields.
                  Args:
                       ...
                       payload (dict): Payload contains custom `set_customer_session_fields` object.
                  Returns:
                    dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def delete_chat_properties(self,
        ...
        ''' Deletes chat properties.
                  Args:
                      ...
                      payload (dict): Payload contains custom `delete_chat_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def update_chat_properties(self,
        ...
        ''' Updates chat properties.
                  Args:
                      ...
                      payload (dict): Payload contains custom `update_chat_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def delete_thread_properties(self,
        ...
        ''' Deletes thread properties.
                  Args:
                      ...
                      payload (dict): Payload contains custom `delete_thread_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def update_thread_properties(self,
        ...
        ''' Updates thread properties.
                  Args:
                      ...
                      properties (dict): Chat properties to set.
                      payload (dict): Payload contains custom `update_thread_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def delete_event_properties(self,
        ...
        ''' Deletes event properties.
                  Args:
                      ...
                      payload (dict): Payload contains custom `delete_event_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
    ...
    def update_event_properties(self,
        ...
        ''' Updates event properties.
                  Args:
                      ...
                      properties (dict): Chat properties to set.
                      payload (dict): Payload contains custom update_event_properties` object.
                  Returns:
                      dict: Dictionary with response.
          '''
        if payload is None:
