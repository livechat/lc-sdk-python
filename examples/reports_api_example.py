...
chats_occured = reports_api.total_chats(to='2020-09-14T23:59:59+02:00',
                                        from_param='2020-09-01T00:00:00+02:00')
print(chats_occured.text)
