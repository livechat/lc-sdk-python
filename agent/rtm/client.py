...
class AgentRTMInterface(metaclass=ABCMeta):
    ...
    def change_push_notifications(self,
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'change_push_notifications', 'payload': payload})
    ...
    def set_routing_status(self,
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'set_routing_status', 'payload': payload})
    ...
    def list_routing_statuses(self, filters: dict = None, payload: dict = None) -> dict:
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'list_routing_statuses', 'payload': payload})
    ...
    def grant_chat_access(self, id: str = None, access: dict = None, payload: dict = None) -> dict:
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'grant_chat_access', 'payload': payload})

    def revoke_chat_access(self, id: str = None, access: dict = None, payload: dict = None) -> dict:
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'revoke_chat_access', 'payload': payload})
    ...
    def remove_user_from_chat(self,
        ...
        if payload is None:
            payload = prepare_payload(locals())
        return self.ws.send({'action': 'remove_user_from_chat', 'payload': payload})
